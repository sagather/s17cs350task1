...
public class Tester2
{
    ...
    private void goFuckingDockWithYourselfTappan()
    {
        ...
        List<List<Point3D>> anotherList = boxC.NEW_generateFramesAll();
        System.out.println();
        System.out.println();
    ...
    private void frameGenerationTest()
    {
        ...
        ArrayList<Point3D> pointList = (ArrayList<Point3D>) boxA.NEW_generateFrameSelf();
        ...
        ArrayList<List<Point3D>> anotherList = (ArrayList<List<Point3D>>) boxA.NEW_generateFramesAll();
        System.out.println();
        System.out.println();
    ...
    private void checkBoundingBoxExtend()
    {
        ...
        cornerList = (ArrayList<Point3D>) extBox.generateCorners();
