...
*/
        ...
        this.goThumpYourself();

    }

    private void fuckingTejjie()
    {
        Box boxA = new Box("boxA", new Dimension3D(1,2,3), true);
        Box boxB = new Box("boxB", new Dimension3D(10,16.5,20));
        boxA.connectChild(new Connector(boxB, new Point3D(6,13.25,3)));
        BoundingBox boundingBox = boxA.NEW_generateBoundingBoxSelf();
        BoundingBox daBox = boundingBox.extend(boundingBox);

        System.out.println();
        System.out.println("TEST VOLUME, should be 6.0");
        System.out.println("Actual: " + daBox.calculateVolume());


        System.out.println("TEST AREA XY, should be 4.0");
        System.out.println("Actual: " + daBox.calculateArea(BoundingBox.E_Plane.XY));


        System.out.println("TEST AREA YZ, should be 12.0");
        System.out.println("Actual: " + daBox.calculateArea(BoundingBox.E_Plane.YZ));


        System.out.println("TEST AREA XZ, should be 6.0");
        System.out.println("Actual: " + daBox.calculateArea(BoundingBox.E_Plane.XZ));
    }
    private void goThumpYourself()
    {
        Box boxA = new Box("boxA", new Dimension3D(1,2,3), true);
        Box boxB = new Box("boxB", new Dimension3D(10,16.5,20));
        Box boxC = new Box("boxC", new Dimension3D(11,13,13.25));

        boxA.connectChild(new Connector(boxB, new Point3D(6,13.25,3)));
        boxB.connectChild(new Connector(boxC, new Point3D(9.5,-7.75, 11.25)));

        BoundingBox boundingBox = boxB.NEW_generateBoundingBoxAll();

        List<Point3D> anotherList = (List<Point3D>) boundingBox.generateCorners();
        System.out.println();
    ...
    private void checkBoundingBox()
    {
        ...
        cornerList = (List<Point3D>) boundingD.generateCorners();
        System.out.println("Generating Corners should be: ");
        ...
        cornerList = (List<Point3D>) boundingE.generateCorners();
        System.out.println("Generating Corners should be: ");
        ...
        cornerList = (List<Point3D>) genBox.generateCorners();
